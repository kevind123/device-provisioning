const bacnetDeviceRequest = {
	...
	device: {
		...
		deviceInfos: [
			...
			{
				deviceInfoCd: 'BU3szko7y2lnUE84q10c',
				infoTypeLcd: 'IT_SUB_ADDRESS_GENERIC',
				text: 'BU3szko7y2lnUE84q10c',
				values: [3, "9"]
			}
		],
		bridge: {
			bridgeCd: 'LPDjei1f2Bh6MBNJ4pzX-I37YifZSqBC1NPSa7g3T',
			bridgeName: 'Candi CC150 Gateway-Ethernet-BACnet IP - AHU'
		}
	} //contains product and label mappings (deviceInfos)
};


exports.bacnetDeviceRequest = bacnetDeviceRequest;